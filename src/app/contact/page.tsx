  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center font-sans p-8 relative z-20">
      ...
      <div className="flex gap-8 relative z-20">
        <a
          href="mailto:jorgeagrullon@gmail.com"
          className="group hover:text-blue-300 text-lg sm:text-xl font-semibold flex flex-col items-center gap-2"
        >
          <svg
            width="32"
            height="32"
        ...
        <a
          href="https://www.linkedin.com/in/jorge-grullon-8673182b9/"
          target="_blank"
          rel="noopener noreferrer"
          className="group hover:text-blue-300 text-lg sm:text-xl font-semibold flex flex-col items-center gap-2"
        >
