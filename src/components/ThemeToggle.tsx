...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className={`relative flex h-12 w-[88px] items-center rounded-full border px-1.5 transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 sm:absolute sm:right-6 sm:top-[calc(50%+52px)] sm:-translate-y-1/2 ${
        isLight
