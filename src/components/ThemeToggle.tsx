...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className={`absolute right-6 top-[calc(50%+52px)] flex h-12 w-[88px] -translate-y-1/2 items-center rounded-full border px-1.5 transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 ${
        isLight
